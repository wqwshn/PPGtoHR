...
%% 2. 基础配置
% 数据文件路径 (请确认路径正确)
para_base.FileName = 'data20260323\HR_new_tiaosheng2_processed.mat'; 
...
% 利用 fullfile 将原路径与新文件名拼接。如果没写路径，则默认保存在当前目录
if isempty(dataPath)
